...
The utilization of the classwms GUI mandates the presence of MATLAB R2021a version or higher. 

To use the tool, individuals can obtain the required files from GitHub: https://github.com/AYOUBELATTMANIA/classwms.git. 
This pertains specifically to the source code and accompanying support materials, encompassing:
...
To start using the classwms GUI, users need to rename the downloaded folder from the aforementioned GitHub link to ‘classwms’ and subsequently transfer it to C drive (C:). 
